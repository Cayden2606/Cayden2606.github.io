...
<h3 class="mt-6 mb-3">Pasir Ris East Youth Network (Volunteering)</h3>

<h4 class="mt-4 mb-2">Mid-Autumn Festival (4 Oct 2025)</h4>
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-2 mb-6">
  <div class="flex flex-col items-center">
    ...
    <div class="text-sm text-gray-600 dark:text-gray-300 mt-1">Community event support</div>
  </div>
  <div class="flex flex-col items-center">
    ...
    <div class="text-sm text-gray-600 dark:text-gray-300 mt-1">On-ground coordination</div>
  </div>
</div>
...
<h4 class="mt-6 mb-2">Halloween Event (12 Oct 2025)</h4>
...
<h3 class="mt-6 mb-3">Project Smile (Community Support)</h3>
...
<h3 class="mt-6 mb-3">Student Mentor Programme (NYP) — 2024</h3>
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-2 mb-6">
  ...
  <div class="flex flex-col items-center">
    ...
    <div class="text-sm text-gray-600 dark:text-gray-300 mt-1">Mentoring & guidance</div>
  </div>
</div>
...
<h3 class="mt-6 mb-3">World Robot Games (WRG) — 2024</h3>
