...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;">
  <img src="Media/MainPage.png" alt="Home Dashboard" style="flex: 1 1 300px; max-width: 500px; margin-top: 0; margin-bottom: 0;">
</div>

### **Alarm & Stopwatch**
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;">
  <img src="Media/Alarm.png" alt="Alarm Management" style="flex: 1 1 300px; max-width: 500px; margin-top: 0; margin-bottom: 0;">
</div>

### **App Switcher**
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;">
  <img src="Media/AppSwitcher.png" alt="App Switcher" style="flex: 1 1 300px; max-width: 500px; margin-top: 0; margin-bottom: 0;">
</div>

### **Doodle + AI Chat**
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;">
  <img src="Media/Doodle+AI.png" alt="Doodle + AI" style="flex: 1 1 300px; max-width: 500px; margin-top: 0; margin-bottom: 0;">
</div>

### **MediaHub: Music, Radio, Video**
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
  <img src="Media/MediaHub-Music.png" alt="Music" style="flex: 1 1 150px; max-width: 200px; margin-top: 0; margin-bottom: 0;">
  <img src="Media/MediaHub-Radio.png" alt="Radio" style="flex: 1 1 150px; max-width: 200px; margin-top: 0; margin-bottom: 0;">
  <img src="Media/MediaHub-Video.png" alt="Video" style="flex: 1 1 150px; max-width: 200px; margin-top: 0; margin-bottom: 0;">
</div>

### **MediaHub: Expanded Views**
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
  <img src="Media/MediaHub-Music-Expand.png" alt="Music Expanded" style="flex: 1 1 150px; max-width: 200px; margin-top: 0; margin-bottom: 0;">
  <img src="Media/MediaHub-Radio-Expand.png" alt="Radio Expanded" style="flex: 1 1 150px; max-width: 200px; margin-top: 0; margin-bottom: 0;">
  <img src="Media/MediaHub-Video-Expand.png" alt="Video Expanded" style="flex: 1 1 150px; max-width: 200px; margin-top: 0; margin-bottom: 0;">
</div>
