...
<div class="flex flex-col items-center max-w-prose mx-auto gap-3 justify-center">
  ...
  <div class="grid grid-cols-2 gap-4">
    ...
    <div class="flex flex-col items-center">
      <img src="Award-Testimonial/Director_List_Sem_2.png" alt="Director's List Semester 2" class="w-32 h-auto">
      <div class="text-sm text-gray-700 dark:text-gray-300">Director's List Semester 2</div>
    </div>
    <div class="flex flex-col items-center">
      <img src="Award-Testimonial/Director_List_Sem_1.png" alt="Director's List Semester 1" class="w-32 h-auto">
